...
from gwinferno.pipeline.utils import setup_bspline_mass_models, setup_bspline_spin_models, setup_powerlaw_spline_redshift_model
...
def run_analysis(numpyro_model, pedict, injdict, constants, param_names, nspline_dict, parsargs, skip_inference = False):
    ...
    mag_model, tilt_model = setup_bspline_spin_models(pedict, injdict, nspline_dict['a1'], nspline_dict['tilt1'], IID = False, a2_nsplines = nspline_dict['a2'], ct2_nsplines = nspline_dict['tilt2'])
    ...
    if not skip_inference:
        ...
        mcmc.run(rng_key_, pedict, injdict, constants['nObs'], constants['obs_time'], constants['total_inj'], mass_models, mag_model, tilt_model, z_model, parsargs.mmin, parsargs.mmax, nspline_dict, param_names)
